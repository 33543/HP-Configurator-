...
st.write(f"Annual Emissions (Gas): {carbon_gas:.1f} kg CO2e")
st.write(f"Annual Emissions (Heat Pump): {carbon_hp:.1f} kg CO2e")
st.write(f"Carbon Saved per Year: {carbon_savings:.1f} kg CO2e")
...
if st.button("Generate PDF Report"):
    ...
    text_lines = [
        ...
        "",
        "Carbon Savings",
        f"- Annual Emissions (Gas): {carbon_gas:.1f} kg CO2e",
        f"- Annual Emissions (Heat Pump): {carbon_hp:.1f} kg CO2e",
        f"- Carbon Saved per Year: {carbon_savings:.1f} kg CO2e",
        "",
        "Payback Period",
